...
@pytest.mark.parametrize(
    ...
    [
        ...
        "https://x/plugins/checkout-rules.js",  # app-owned plugin directory is not vendor evidence
    ],
)
...
def test_banner_detection():
    ...
    assert (
        classify_vendor_file("https://x/js/app.js", content="function init(){ return 1; }") is None
    )
